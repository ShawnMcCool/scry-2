defmodule Scry2.MtgaMemory.Nif do
  ...
  @impl true
  def walk_events(_pid), do: :erlang.nif_error(:nif_not_loaded)

  @impl true
  def walk_account(_pid), do: :erlang.nif_error(:nif_not_loaded)

  @impl true
  def walk_cosmetics(_pid), do: :erlang.nif_error(:nif_not_loaded)

  @impl true
  def walk_environment(_pid), do: :erlang.nif_error(:nif_not_loaded)
