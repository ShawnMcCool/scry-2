defmodule Scry2.MtgaLogs.Event do
  @moduledoc """
  In-memory struct representing a parsed MTGA log event.

  Produced by `Scry2.MtgaLogs.EventParser`. Not to be confused with
  `Scry2.MtgaLogs.EventRecord`, which is the Ecto schema for the
