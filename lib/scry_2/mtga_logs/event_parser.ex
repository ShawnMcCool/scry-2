defmodule Scry2.MtgaLogs.EventParser do
  @moduledoc """
  Pipeline stage 04 — extract `%Scry2.MtgaLogs.Event{}` structs from raw
  Player.log text.
  ...
  | **Called from** | `Scry2.MtgaLogs.Watcher.drain_file/1` (stage 03 → 04) |
  | **Hands off to** | `Scry2.MtgaLogs.insert_event!/1` (stage 04 → 05) |
