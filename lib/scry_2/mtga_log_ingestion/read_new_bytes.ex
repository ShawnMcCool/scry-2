defmodule Scry2.MtgaLogIngestion.ReadNewBytes do
  @moduledoc """
  ...
  The Watcher GenServer composes this with `ExtractEventsFromLog` and the
  `MtgaLogIngestion` context to land raw events in the database.
  """
