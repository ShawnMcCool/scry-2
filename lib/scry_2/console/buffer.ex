defmodule Scry2.Console.Buffer do
  @moduledoc """
  ...
  See `Scry2.Console.Handler` for the reentrancy guard on buffer's own
  failure logs.
  """
  use GenServer
  ...
  def handle_info(:persist, state) do
    try do
      ...
      error ->
        ...
        # Tag with scry2_log_source: :buffer so Console.Handler's reentrancy
