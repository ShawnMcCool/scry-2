defmodule Scry2.Cards.Synthesize.MergeFieldsTest do
  ...
  # The (set, number) collision tiebreaker moved to
  # `Scry2.Cards.BasicPrinting` — its scenarios (flavor-name rows,
  # booster preference) live in `Scry2.Cards.BasicPrintingTest`.
end
